...
export default function Page() {
  ...
  useEffect(() => {
    if (yesPressed && noCount < 4 && !popupShown) {
      Swal.fire({
        title: "Pooja, I love you so much! ❤️ You have my whole heart, but thoda aur nakhre dikhao na, please! 🥰✨",
        showClass: {
          popup: `
            animate__animated
            animate__fadeInUp
  ...
  useEffect(() => {
    if (yesPressed && noCount > 3 && !yespopupShown) {
      Swal.fire({
        title: "Pooja, I love you so much!! ❤️ You are my joy, my forever, my everything. Every moment with you means the world to me.</br> Yours always, Bharath.",
        width: 800,
        padding: "2em",
        color: "#716add",
        background: `#fff url(${swalbg})`,
  ...
  useEffect(() => {
    if (noCount == 25) {
      Swal.fire({
        title: "Pooja, my love for you is endless, like the stars in the sky. 🌟 I will keep choosing you every day. ❤️ Please press 'Yes' and let us make this a forever story, from Bharath to Pooja. 🥰✨",
        width: 850,
        padding: "2em",
        color: "#716add",
        background: `#fff url(${swalbg})`,
        ...
        {yesPressed && noCount>3 ? (
          <>
            <img
              ...
              alt="Yes Response"
            />
            <div className="text-4xl md:text-6xl font-bold my-2" style={{ fontFamily: "Charm, serif", fontWeight: "700", fontStyle: "normal" }}>I Love You, Pooja!!!</div>
            <div className="text-4xl md:text-4xl font-bold my-1" style={{ fontFamily: "Beau Rivage, serif", fontWeight: "500", fontStyle: "normal" }}>Forever yours, Bharath.</div>
            <WordMareque />

            <div className="love-photo-frame love-photo-frame-floating">
              <span className="love-frame-decor love-frame-heart-one">💖</span>
              <span className="love-frame-decor love-frame-heart-two">❤️</span>
              <span className="love-frame-decor love-frame-flower-one">🌸</span>
              <span className="love-frame-decor love-frame-flower-two">🌺</span>
              <span className="love-frame-decor love-frame-flower-three">🌼</span>

              <div className="love-photo-inner">
                <img src="/us.jpg" alt="Bharath and Pooja" />
              </div>
              <p className="love-photo-caption">Bharath ❤️ Pooja</p>
            </div>
          </>
        ) : (
          <>
            ...
            <h1 className="text-4xl md:text-6xl my-4 text-center">
              Pooja, will you be my Valentine?
            </h1>
...
const Footer = () => {
  return (
    <div className="fixed bottom-2 right-2 backdrop-blur-md opacity-90 border p-2 rounded border-rose-300 bg-white/30">
      Made with <span role="img" aria-label="heart">❤️</span> by Bharath for Pooja
    </div>
  );
};
